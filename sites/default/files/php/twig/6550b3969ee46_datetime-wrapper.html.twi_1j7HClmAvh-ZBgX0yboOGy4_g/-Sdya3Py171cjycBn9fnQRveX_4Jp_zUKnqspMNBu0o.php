...
class __TwigTemplate_431cd500f9d6abc7239b4b09c661d758 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 10
        $context["title_classes"] = [0 => "form-item__label", 1 => ((        // line 12
($context["required"] ?? null)) ? ("js-form-required") : ("")), 2 => ((        // line 13
($context["required"] ?? null)) ? ("form-required") : ("")), 3 => ((        // line 14
...
";
        ...
        if (($context["description"] ?? null)) {
            // line 28
            echo "  <div";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["description_attributes"] ?? null), "addClass", [0 => "form-item__description"], "method", false, false, true, 28), 28, $this->source), "html", null, true);
            echo ">
    ";
            // line 29
